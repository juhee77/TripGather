...
public class QUserMission extends EntityPathBase<UserMission> {
    ...
    public final ListPath<UserMissionStep, QUserMissionStep> steps = this.<UserMissionStep, QUserMissionStep>createList("steps", UserMissionStep.class, QUserMissionStep.class, PathInits.DIRECT2);
